...
public class User {
	...
	@Size(min=4, max=20,groups={PersistenceValidationGroup.class, FormValidationGroup.class})
	@Id
	...
	@NotBlank(groups={PersistenceValidationGroup.class, FormValidationGroup.class})
	@Size(min=6, max=30,groups={PersistenceValidationGroup.class, FormValidationGroup.class})
	private String name;
